...
public class RegisteredCourseModel {
	...
	/** Get this course's type. */
	public String getType() {
		return type;
	}

	/** Get this course's room. */
	...
	public String toString() {
		...
		sb.append(this.subject + " " + this.catalog + ": " + this.title);	
		return sb.toString();
	}
	...
	public boolean equals(Object obj){
		...
		RegisteredCourseModel comparedCourse = (RegisteredCourseModel) obj;    
		return (subject.equals(comparedCourse.getSubject())
				&& 
				catalog.equals(comparedCourse.getCatalog())
				&&
				sec.equals(comparedCourse.getSec())
				);
	}
	...
	public String getDayTime(){
		...
		sb.append(" " + this.startTime.substring(0,5) + "-" + this.endTime.substring(0,5));
		return sb.toString();
	}
	 ...
	 */
	public static List<RegisteredCourseModel> getCourses(String userID, String password) throws HttpPostException {
